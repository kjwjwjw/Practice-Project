...
<body>
   <div id="wrap">
      ...
      <!-- 본문들어가는 곳 -->
        ...
        <article>
           <h1>Join Us</h1>
           <form action="joinpro.jsp" method="get" id="join" name="fr" onsubmit="return checkSubmit()">
              <fieldset>
                 <legend>Basic Info</legend>
                 <label>User Id</label>
                 <input type="text" name="id" class="id" id="id" required="required" placeholder="중복확인 버튼체크" readonly="readonly">
