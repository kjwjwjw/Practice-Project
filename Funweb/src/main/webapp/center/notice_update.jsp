		...
		<article>
			...
			<input type="hidden" name="page" value="<%=pageNum %>">
				<table id="notice">
					<tr>
						<td>글쓴이</td>
						<td><input type="text" value="<%=board.getName() %>" name="name" required="required"></td>
					</tr>
					<tr>
						<td>비밀번호</td>
						<td><input type="password" name="pass" value="<%=board.getPass() %>" required="required"></td>
					</tr>
					<tr>
						<td>제목</td>
						<td><input type="text" value="<%=board.getSubject() %> " name="subject" required="required"></td>
					</tr>
					<tr>
						<td>내용</td>
